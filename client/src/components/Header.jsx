...
const Header = () => {
  ...
  return (
    <div className='flex flex-col items-center mt-20 px-4 text-center text-gray-800'>
        ...
        <h1 className='flex items-center gap-2 text-xl sm:text-3xl font-medium mb-2'>Hi {userData ? userData.name : "Developer"}!  <img src={assets.hand_wave} alt="" className="w-8 aspect-square" /></h1>
